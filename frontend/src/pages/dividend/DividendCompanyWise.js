  ...
  return (
    <>
      ...
      <div className="dashboard-container">
        <Container fluid>
          <h2 className="dashboard-header">💼 Stock Dividend Payable - Company-wise View</h2>
          ...
          {loading ? (
            ...
            <Card className="chart-card-modern">
              <Card.Header><FaChartBar style={{ marginRight: '0.5rem' }} /> Company-wise Dividend Report</Card.Header>
              <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h5>{data.length} companies ({rangeText})</h5>
                </div>
                {data.length > 0 ? (
