  ...
  return (
    <>
      ...
      <div className="dashboard-container">
        <Container fluid>
          <h2 className="dashboard-header">👔 Stock Dividend Payable - Promoter</h2>
          ...
          {loading ? (
            ...
            <Card className="chart-card-modern">
              <Card.Header><FaChartBar style={{ marginRight: '0.5rem' }} /> Promoter Dividend Report</Card.Header>
              <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h5>{data.length} promoter groups ({rangeText})</h5>
                </div>
                {data.length > 0 ? (
