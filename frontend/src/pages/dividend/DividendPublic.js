  ...
  return (
    <>
      ...
      <div className="dashboard-container">
        <Container fluid>
          <h2 className="dashboard-header"><FaBuilding style={{ marginRight: '0.5rem' }} /> Stock Dividend Payable - Public Sector</h2>
            ...
            <Card className="chart-card-modern">
              ...
              <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h5>{data.length} public sector companies ({rangeText})</h5>
                </div>
                {data.length > 0 ? (
