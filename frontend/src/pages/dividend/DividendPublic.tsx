/**
 * Dividend Payable - Public Sector View
 * Phase 2 Optimized
 */
...
const DividendPublic: React.FC = () => {
  ...
  }, [dividendData, dateRange, publicSectorCompanyIds]);
  ...
  const handleExport = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute('download', `dividend-public-${new Date().toISOString().split('T')[0]}.xlsx`);
      ...
      <div className="dashboard-container">
        <Container fluid>
          <h2 className="dashboard-header">
            <FaUsers style={{ marginRight: '0.5rem' }} /> Dividend Payable - Public Sector
          </h2>
          ...
          <Card className="chart-card-modern">
            ...
            <Card.Body className="p-0">
              <DataTable
                ...
                isLoading={isLoading}
                emptyMessage="No public sector dividend payables found"
              />
            </Card.Body>
          </Card>
