/**
 * Dividend Payable - Tax-Exempted Sector View
 * Phase 2 Optimized
 */
...
const DividendTaxExempted: React.FC = () => {
  ...
  }, [dividendData, dateRange, taxExemptedCompanyIds]);
  ...
  const handleExport = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute('download', `dividend-taxexempted-${new Date().toISOString().split('T')[0]}.xlsx`);
      ...
      <div className="dashboard-container">
        <Container fluid>
          <h2 className="dashboard-header">
            <FaUsers style={{ marginRight: '0.5rem' }} /> Dividend Payable - Tax-Exempted Sector
          </h2>
          ...
          <Card className="chart-card-modern">
            ...
            <Card.Body className="p-0">
              <DataTable<DividendSectorData>
                ...
                isLoading={isLoading}
                emptyMessage="No tax-exempted sector dividend payables found"
              />
            </Card.Body>
          </Card>
